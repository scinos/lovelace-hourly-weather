...
| `icon_fill`                      | bool             | **Optional** | Whether to repeat the icon inside the bar (one icon per segment)                                                                                                | `false`             |
| `official_icons`                 | bool             | **Optional** | Whether to use the icons from the official Weather Forecast card                                                                                                | `false`             |
| `segment_spacing`                | number           | **Optional** | Space between icons when using `icon_fill:true` (integer >= 1)                                                                                                  | `1`                 |
